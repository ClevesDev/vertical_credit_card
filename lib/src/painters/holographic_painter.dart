...
class HolographicFoilPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final barGradient = LinearGradient(
      ...
      colors: [
        Colors.transparent,
        Colors.white.withValues(alpha: intensity * 0.15),
        Colors.cyanAccent.withValues(alpha: intensity * 0.45),
        Colors.pinkAccent.withValues(alpha: intensity * 0.45),
        Colors.amberAccent.withValues(alpha: intensity * 0.45),
        Colors.white.withValues(alpha: intensity * 0.15),
        Colors.transparent,
      ],
